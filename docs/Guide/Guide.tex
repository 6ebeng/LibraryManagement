...
docker-compose -f docker-compose.test.yml up --build
    ...
    \begin{itemize}
        ...
        \item The Node.js backend API will be running on \href{http://localhost:8080}{\texttt{http://localhost:8080}}.
    \end{itemize}
...
\begin{description}
    \item[Run Dev Environment:] \texttt{docker-compose -f docker-compose.test.yml up --build}

\begin{longtable}{|>{\scriptsize\raggedright\arraybackslash}p{3cm}|>{\raggedright\arraybackslash}p{3.5cm}|>{\raggedright\arraybackslash}p{4cm}|>{\raggedright\arraybackslash}p{5cm}|}
...
% Scope Definition
\multicolumn{4}{|p{16cm}|}{\textbf{Testing Scope:} Tests are to be executed on the latest stable versions of the following browsers as specified in the SRS  and testing plan: Google Chrome, Mozilla Firefox, Microsoft Edge, and Safari.} \\ \hline

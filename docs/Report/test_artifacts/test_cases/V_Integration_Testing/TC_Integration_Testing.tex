...
\title{V. Integration Test Cases \\ \large Library Management System}
...
\maketitle
\begin{center}
    \textbf{Note:} These test cases are designed to verify the interaction and data flow between different modules of the Library Management System, as per the SRS and project test plan. They focus on end-to-end user scenarios that span multiple system components.
\end{center}

\section*{V. Integration Test Cases}

\begin{longtable}{|>{\raggedright\arraybackslash}p{3cm}|>{\raggedright\arraybackslash}p{4cm}|>{\raggedright\arraybackslash}p{5.5cm}|>{\raggedright\arraybackslash}p{5.5cm}|}

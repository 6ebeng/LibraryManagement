\begin{longtable}{|>{\scriptsize\raggedright\arraybackslash}p{4.2cm}|>{\raggedright\arraybackslash}p{3.5cm}|>{\raggedright\arraybackslash}p{3.5cm}|>{\raggedright\arraybackslash}p{3.8cm}|}
...
TC\_REVIEW\_CREATE\_001 & Successful review creation by Member & 
    \begin{itemize}[noitemsep, topsep=0pt, partopsep=0pt, leftmargin=*]

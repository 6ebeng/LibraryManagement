...
\input{./test_artifacts/test_cases/III_Unit_Testing/III_Unit_Testing.tex}
...
\input{./test_artifacts/test_cases/V_Integration_Testing/TC_Integration_Testing.tex}
...
\input{./test_artifacts/test_cases/I_Functional_Testing/TC_Authentication_Authorization/TC_Authentication_Authorization.tex}

\subsubsection{Entity Management Testing}
\input{./test_artifacts/test_cases/I_Functional_Testing/TC_Entity_Management/TC_Entity_Management.tex}

\subsubsection{Use Case Testing}
\input{./test_artifacts/test_cases/I_Functional_Testing/TC_Use_Case_Testing/TC_Use_Case_Testing.tex}

\subsubsection{State Transition Testing}
\input{./test_artifacts/test_cases/I_Functional_Testing/TC_State_Transition_Testing/TC_State_Transition_Testing.tex}

\subsubsection{Specific Feature Testing}
\input{./test_artifacts/test_cases/I_Functional_Testing/TC_Specific_Feature_Testing/TC_Specific_Feature_Testing.tex}
...
\input{./test_artifacts/test_cases/II_API_Testing/TC_API_Testing.tex}
...
\end{itemize}
\input{./test_artifacts/test_cases/III_White-Box_Testing/TC_White_Box_Testing.tex}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/jest/coverage_test_report_jest_backend.png}
...
\input{./test_artifacts/test_cases/IV_Non-Functional_Testing/TC_Performance_Testing/TC_Performance_Testing.tex}

\subsubsection{Security Testing}
\input{./test_artifacts/test_cases/IV_Non-Functional_Testing/TC_Security_Testing/TC_Security_Testing.tex}

\subsubsection{Usability Testing}
\input{./test_artifacts/test_cases/IV_Non-Functional_Testing/TC_Usability_Testing/TC_Usability_Testing.tex}
...
\input{./test_artifacts/test_cases/IV_Non-Functional_Testing/TC_Browser_Compatibility_Testing/TC_Browser_Compatibility_Testing.tex}
...
\input{./test_artifacts/test_cases/VI_Regression_Testing/TC_Regression_Testing.tex}
...
\input{./test_artifacts/test_cases/VII_Installation_Deployment_Testing/TC_Installation_Deployment_Testing.tex}
...
\end{itemize}
\input{./test_artifacts/test_cases/VIII_Static_Testing/TC_Static_Testing.tex}

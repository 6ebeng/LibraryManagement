...
\pagestyle{fancy}
\fancyhf{}
\rhead{Library Management System}
\lhead{Test Design Document}
\cfoot{\thepage}
...
\title{
    ...
    \large{Software Test Design Document}
}
\author{Tishko}
\date{\today}
\maketitle

\section{Authentication Controller (authController)}
\subsection{Overview}
...
\section{Author Controller (authorController)}
\subsection{Overview}
...
\section{Book Controller (bookController)}
\subsection{Overview}
...
\section{Borrowal Controller (borrowalController)}
\subsection{Overview}
...
\section{Genre Controller (genreController)}
\subsection{Overview}
...
\section{Review Controller (reviewController)}
\subsection{Overview}

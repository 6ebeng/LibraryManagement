...
\title{Non-Functional Test Cases: Browser Compatibility Testing \\ \large Library Management System}
...
\maketitle
\begin{center}
    \textbf{Note:} These test cases are designed to verify the consistency of the application's appearance and functionality across different web browsers, based on SRS section 2.4  and the testing plan. The primary responsibility for execution lies with the Non-Coders/Specification Experts. Actual results and status are to be filled in during test execution.
\end{center}

\section*{IV.E Non-Functional Test Cases: Browser Compatibility Testing}

...
\title{Functional Test Cases: State Transition Testing \\ \large Library Management System}
...
\maketitle
\begin{center}
    \textbf{Note:} These test cases are designed from a black-box, user-centric perspective based on SRS requirements for entities with distinct states.  Actual results and status are to be filled during test execution. Refer to the SRS for complete requirements. 
\end{center}

\section*{I.E Functional Test Cases: State Transition Testing}

\begin{longtable}{|>{\raggedright\arraybackslash}p{4cm}|>{\raggedright\arraybackslash}p{4cm}|>{\raggedright\arraybackslash}p{4.5cm}|>{\raggedright\arraybackslash}p{4cm}|}
